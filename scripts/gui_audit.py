...
class GUIAuditor:
    ...
    def __init__(self, project_root: Path):  # noqa: D107
        ...
        self.mixin_whitelist = {
            ...
            "on_city_selected",
            "on_location_changed",
            "on_date_range_changed",
            "on_date_mode_changed",
            "on_provider_changed",
            "on_fetch_requested",
            "on_cancel_requested",
            "on_analysis_type_changed",
            "on_multi_city_selection_changed",
            "on_api_settings_changed",
            "on_query_clicked",
            "on_progress",
            "on_error",
            "on_completed",
            ...
            "on_tab_changed",
            "on_anomaly_settings_clicked",
            "on_detailed_analysis_clicked",
            "on_period_type_changed",
            "on_loading_timeout",
            "on_settings_changed",
            "on_button_clicked",
            "on_chart_clicked",
            ...
            "on_county_changed",
            "start_data_loading",
            "center_map_on_selection",
            "on_counties_loaded",
            "on_postal_codes_loaded",
            "on_data_error",
            "on_data_loading_completed",
            "on_map_generated",
            "on_map_error",
            "on_server_ready",
            "on_server_error",
            "on_county_clicked",
            "on_coordinates_clicked",
            "on_map_moved",
            "on_county_hovered",
            "on_export_completed",
            "map_ready",
            ...
            "city_selected",
            "search_requested",
            "_on_analysis_started",
            "_on_analysis_completed",
            "_on_analysis_failed",
            "_on_analysis_cancelled",
            "_on_provider_selected",
            "_on_provider_usage_updated",
            "_on_provider_warning",
            "_on_provider_fallback",
            "_on_local_error",
            "_on_analysis_requested",
            "_handle_export_request",
            "_show_extreme_weather",
            "_handle_analytics_view_query",
            "_on_progress_clean",
            "update_data",
            "on_time_range_changed",
            "on_manual_date_changed",
            "set_last_month",
            "set_last_year",
            "on_provider_selection_changed",
            "on_combo_selection_changed",
            "on_auto_reset",
