...
class MapView(
    ...
    """
    Map View Widget - Teljes magyar Folium térképes nézet.
    ...
    def get_map_tab(self) -> Optional[HungarianMapTab]:
        """
        Folium HungarianMapTab referencia lekérdezése.
    ...
    def get_map_visualizer(self):
        """
        Folium map visualizer referencia lekérdezése (delegált).
    ...
    def set_weather_data(self, weather_data: Dict[str, Any]) -> None:
        """
        Időjárási adatok beállítása Folium overlay-hez (delegált).
