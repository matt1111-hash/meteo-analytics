...
class AnalyticsStatistics:
    ...
    @staticmethod
    def _compute_precipitation_stats(daily_data: Dict[str, List[Any]], dates: List[str]) -> Dict[str, Any]:
        stats: Dict[str, Any] = {}
    ...
    @staticmethod
    def _find_longest_dry_streak(precip_list: List[float], dates: List[str]) -> Optional[Dict[str, Any]]:
