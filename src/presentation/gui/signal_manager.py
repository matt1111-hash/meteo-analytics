...
class SignalManager:
    ...
    def connect_all_signals(self) -> None:
        """
        CLEAN MVC komponensek signal-slot összekötése + ANALYTICS SIGNAL FIX + PROVIDER STATUS SIGNALS.
        """
    ...
    def _connect_control_panel(self) -> None:
        ...
        if self.mw.control_panel:
            # Egyetlen központi kapcsolat - minden elemzési kérést az AppController kezel
    ...
    def _connect_app_controller(self) -> None:
        ...
        # Elemzés befejezése (SIKER) - VÁROS ELEMZÉS FIX
    ...
    def _connect_analytics_view(self) -> None:
        ...
        if self.mw.analytics_panel:
            ...
            # Analytics View multi_city_query_requested signal
