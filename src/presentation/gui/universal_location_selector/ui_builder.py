...
def create_universal_location_selector_ui(parent_widget: QWidget) -> dict:
    """
    UI elemek letrehozasa universal location selectorhoz.

    Args:
        parent_widget: Szulo widget
    ...
    # === HEADER ===
    header_label = QLabel("Magyar + Global Lokacio Kereses")
    header_font = QFont()
...
def _create_search_group() -> tuple:
    """Search group letrehozasa."""
    search_group = QGroupBox("Kombinalt Kereses")
    ...
    search_input.setPlaceholderText(
        "Magyar telepulesek + 44k globalis varos... (pl. Kiskunhalas, Abaliget, London)"
    )
    ...
    # Status label
    status_label = QLabel("Kezdj el gepelni a kereseshez...")
...
def _create_results_group() -> tuple:
    """Results group letrehozasa."""
    results_group = QGroupBox("Keresesi Eredmenyek")
...
def _create_selection_group() -> tuple:
    """Selection group letrehozasa."""
    selection_group = QGroupBox("Kivalasztott Lokacio")
    ...
    # Confirm button
    confirm_button = QPushButton("Lokacio Megerositese")
