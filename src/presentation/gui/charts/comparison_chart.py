...
class MultiYearComparisonChart(WeatherChart):
    ...
    def _plot_multi_year_comparison(self, df: pd.DataFrame) -> None:
        ...
        trend_colors = {
            "year_comparison": [
                self.color_palette.get_color("primary", "base")
        ...
        for i, year in enumerate(years):
            ...
            color = trend_colors["year_comparison"][
                i % len(trend_colors["year_comparison"])
            ]
