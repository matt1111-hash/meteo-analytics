...
def safe_statistics_mean(values: list[NumberOrNone]) -> float | None:
    """Legacy wrapper → domain safe_mean."""
...
def safe_statistics_median(values: list[NumberOrNone]) -> float | None:
    """Legacy wrapper → domain safe_median."""
...
def safe_statistics_stdev(values: list[NumberOrNone]) -> float | None:
    """Legacy wrapper → domain safe_stdev."""
    return safe_stdev(values)


def safe_min_max(values: list[NumberOrNone]) -> tuple[float | None, float | None]:
