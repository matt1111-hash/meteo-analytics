...
class TestDeleteProfile:
    ...
    def test_delete_profile_removes_profile_from_cache(
        self, profile_actions: ProfileActions, mock_storage: Mock, mock_get_cache_func: Mock
    ) -> None:
    ...
    def test_delete_profile_resets_to_default_when_active_deleted(
        self, profile_actions: ProfileActions, mock_storage: Mock, mock_active_setter: Mock, mock_get_cache_func: Mock
    ) -> None:
