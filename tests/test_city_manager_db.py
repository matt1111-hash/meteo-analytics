...
class TestModuleStructure:
    ...
    def test_has_all_export(self) -> None:
        ...
        from src.infrastructure.city_manager.city_manager_db import __all__  # noqa: PLC0415

        assert __all__ == ["CityManagerDB"]

    def test_module_docstring_exists(self) -> None:
        """A modul rendelkezik dokumentációval."""
        from src.infrastructure.city_manager.city_manager_db import __doc__  # noqa: PLC0415
