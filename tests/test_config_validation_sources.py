...
class TestGetOptimalDataSource:
    ...
    def test_get_optimal_data_source_single_city(self) -> None:
        from src.config.config_validation import get_optimal_data_source  # noqa: PLC0415
...
class TestGetSourceDisplayName:
    ...
    def test_get_source_display_name_open_meteo(self) -> None:
        from src.config.config_validation import get_source_display_name  # noqa: PLC0415
...
class TestValidateApiSourceAvailable:
    ...
    def test_validate_open_meteo_always_available(self) -> None:
        from src.config.config_validation import validate_api_source_available  # noqa: PLC0415
...
class TestGetFallbackSourceChain:
    ...
    def test_fallback_chain_open_meteo_primary(self, monkeypatch: pytest.MonkeyPatch) -> None:
        from src.config.config_validation import get_fallback_source_chain  # noqa: PLC0415
